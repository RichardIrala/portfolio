const projects = [
  ...
  },
  {
    ...
    description:
      "Utilizando figma diseñe mi portfolio para luego traducirlo a código y deployarlo.",
    image: "assets/projects/portfolioDesign.png",
    code: "",
    deploy: "https://www.figma.com/file/7osZICUMta7OJmlx8ibqLk/Portfolio-RMI?node-id=0%3A1&t=gkvUTfBvaIvEKqN3-0",
  },
  {
    name: "PPOT Online",
    description:
  ...
  },
  {
    name: "Web responsive",
    description:
      "Una de las primeras páginas web responsive que hice. El deploy esta hecho en GitHub Pages.",
